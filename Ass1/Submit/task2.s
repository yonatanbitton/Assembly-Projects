...
;10 is to return to next line, 0 is for null at end of message.	
fmt: db "%d",10,0
...
calc_div:
	...
	;mov esi,0		; the SWAP variable. will be used to swap eax and esi.
	...
	;esi = x, edi = k. first of all, I want k iterations of 2*2.
	...
	;mov [z],eax ; move the resault to the z variable. [Hopefully the decleration is ok]

	;push dword z ;push z to the stack to be printed by the printf
 	push eax
 	push DWORD fmt
